 ...
 const coll =  [
  ...
  return (
    ...
    <LeftCarousel fade>
        {coll.map(item=>{
            return(
                <Carousel.Item className='carousel_item' style={{backgroundImage:`url(${item.imageUrl})`}}>  
        {/* <img
...
<button className='btn btn-danger btn-red'>
  ...
  <h6 className='trend'>
  <svg width="30px" height="30px" viewBox="-3.6 -3.6 31.20 31.20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)" stroke-width="0.00024000000000000003">
